...
public class IndoNumeroController {
    ...
    void handleNuova(ActionEvent event) {
    	...
    	txtLog.clear();
    	txtTentativo.clear();
    	txtLog.setText(String.format("Indivina un numero tra 1 e %d \n", model.getNMAX()));
    }
    ...
    void handleProva(ActionEvent event) {
    	...
    	//numero era un intero e dentro al range
    	...
    	txtCurr.setText(String.format("%d",model.getTentativi()));
    	if(risultato==0) {
    		txtLog.appendText("Hai indivinato! \n");
    	}else if(risultato<0) {
    		txtLog.appendText("Toppo basso! \n");
    	}else {
